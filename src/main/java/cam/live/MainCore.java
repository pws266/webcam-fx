...
public class MainCore extends Application {
	...
	private TextField scaleFactorCtrl;
...
*/
	...
	protected void setImageViewSize() {
		...
		imgWebCamCapturedImage.setFitHeight(Math.floor(height*scaleFactor));
		imgWebCamCapturedImage.setFitWidth(Math.floor(width*scaleFactor));
		imgWebCamCapturedImage.prefHeight(Math.floor(height*scaleFactor));
		imgWebCamCapturedImage.prefWidth(Math.floor(width*scaleFactor));
		imgWebCamCapturedImage.setPreserveRatio(true);

	}

	private void createTopPanel() {
		Label scaleFactorLabel = new Label("Scale factor");
		topPane.getChildren().add(scaleFactorLabel);

		scaleFactorCtrl = new TextField();
		scaleFactorCtrl.setText(Double.toString(scaleFactor));

		topPane.getChildren().add(scaleFactorCtrl);
	...
	protected void startWebCamStream() {
		...
		scaleFactor = Double.parseDouble(scaleFactorCtrl.getText());
		...
		scaleFactorCtrl.setDisable(true);
	...
	protected void disposeWebCamCamera() {
		...
		scaleFactorCtrl.setDisable(false);
	}
